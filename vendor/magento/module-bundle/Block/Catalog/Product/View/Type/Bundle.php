    ...
    public function getBundleProductOptionsData()
    {
       $product = $this->getProduct();
        ...
        foreach ($selectionCollection as $proselection) {
            $selectionArray = [];
			$imageUrl = $store->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . 'catalog/product' . $proselection->getImage();
            $selectionArray = $imageUrl;
            $productsArray[] = $selectionArray;
        }
