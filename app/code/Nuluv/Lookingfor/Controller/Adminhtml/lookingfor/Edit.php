...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Nuluv_Lookingfor::Lookingfor')
            ->addBreadcrumb(__('Nuluv Lookingfor'), __('Nuluv Lookingfor'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Nuluv\Lookingfor\Model\Lookingfor');
        ...
        $this->_coreRegistry->register('lookingfor', $model);

        // 5. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->addBreadcrumb(__('Nuluv'), __('Nuluv'));
