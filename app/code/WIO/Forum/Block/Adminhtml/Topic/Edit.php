...
namespace WIO\Forum\Block\Adminhtml\Topic;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container {
  ...
  protected function _construct() {
    ...
    if ($this->_isAllowedAction('WIO_Forum::topic_delete')) {
  ...
  public function getHeaderText() {
    if ($this->_coreRegistry->registry('topic_model')->getId()) {
      return __("Edit Topic '%1'", $this->escapeHtml($this->_coreRegistry->registry('topic_model')->getTitle()));
    } else {
      return __('New Topic');
    }
  }
