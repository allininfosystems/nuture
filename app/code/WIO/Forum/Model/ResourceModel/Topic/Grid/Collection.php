...
namespace WIO\Forum\Model\ResourceModel\Topic\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use WIO\Forum\Model\ResourceModel\Topic\Collection as TopicCollection;

/**
 * Collection for displaying grid of forum
 */
class Collection extends TopicCollection implements SearchResultInterface {
  ...
  public function getTotalCount() {
    ...
    $select->where('main_table.is_category=?', 0)->where('main_table.is_deleted=?', 0);
    return $this->getSize();
  }
