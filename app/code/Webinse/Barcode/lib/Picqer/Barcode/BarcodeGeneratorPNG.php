...
class BarcodeGeneratorPNG extends BarcodeGenerator
{
    ...
    public function getBarcode($code, $type, $totalHeight = 30, $color = array(0, 0, 0), $colorBg = array(255, 255, 255), $widthFactor = 2)
    {
        ...
        if (function_exists('imagecreate')) {
            ...
            $colorBackground = imagecolorallocate($png, $colorBg[0], $colorBg[1], $colorBg[2]);
        ...
        imagefilledrectangle($png, 0, $totalHeight - 10, $positionHorizontal, $totalHeight, $colorBackground);
        ...
        imagettftext($png, 8, 0, $startTextPosition, $totalHeight - 1, $colorForeground, $font, join('   ', str_split($code)));
        ob_start();
        if ($imagick && isset($imageMagickObject)) {
