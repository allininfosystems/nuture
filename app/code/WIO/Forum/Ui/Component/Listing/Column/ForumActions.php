 ...
 * Class BlockActions
 */
class ForumActions extends Column {

  /**
   * Url path
   */
  const URL_PATH_EDIT = 'wio_forum/forum/edit';
  const URL_PATH_DELETE = 'wio_forum/forum/delete';
  const URL_PATH_DETAILS = 'wio_forum/forum/details';
