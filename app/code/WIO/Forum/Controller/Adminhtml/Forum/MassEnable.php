  ...
  public function execute() {
    ...
    if (is_array($ids)) {
      try {
        ...
        $this->messageManager->addSuccess(__('Total %1 forum(s) enabled', $forumsStatus));
        ...
        $this->messageManager->addException($ex, __('Something went wrong while enabling the forum.'));
      }
    }
