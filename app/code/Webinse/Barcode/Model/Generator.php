 ...
 */
/**
 * Model for the Webinse Barcode Generator list.
 *
 * @category    Webinse
 * @package     Webinse_Barcode
 * @author      Webinse Team <info@webinse.com>
...
class Generator extends \Magento\Framework\Model\AbstractModel implements
    \Webinse\Barcode\Api\Data\GeneratorInterface,
    \Magento\Framework\DataObject\IdentityInterface
{
    const CACHE_TAG = 'webinse_barcode_generator';

    protected $_cacheTag = 'webinse_barcode_generator';

    protected $_eventPrefix = 'webinse_barcode_generator';
    ...
    {
        $this->_init('Webinse\Barcode\Model\ResourceModel\Generator');
    }
