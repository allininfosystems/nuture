...
class MoveBlock implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        if ($this->_dataHelper->moduleEnabled()) {
            ...
            if ($this->_dataHelper->getPlacement() == \Plumrocket\ProductFilter\Model\Config\Source\Placement::PLACEMENT_TOOLBAR) {
                $layout->getUpdate()->addHandle('product_filter_toolbar');
            }
        }
